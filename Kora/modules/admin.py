...
async def spider(spdr):
    ...
    try:
        from Kora.sql.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    # Check if the function running under SQL mode
    try:
        from Kora.sql.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    ...
    try:
        from Kora.sql.gmute_sql import is_gmuted
        from Kora.sql.spam_mute_sql import is_muted
    except AttributeError:
        return
...
async def ungmoot(un_gmute):
    ...
    # Check if the function running under SQL mode
    try:
        from Kora.sql.gmute_sql import ungmute
    except AttributeError:
...
async def gspider(gspdr):
    ...
    # Check if the function running under SQL mode
    try:
        from Kora.sql.gmute_sql import gmute
    except AttributeError:
